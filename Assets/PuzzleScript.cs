...
public class PuzzleScript : MonoBehaviour {
	...
	void createPuzzle() {
		...
		Sprite puzzle = Resources.Load<Sprite>("puzzles/puzzle10");
		puzzleSpriteRenderer.sprite = puzzle;
		puzzleSpriteRenderer.transform.position = new Vector3(0, 0, (float)0.01);
		puzzleSpriteRenderer.transform.localScale = new Vector3((float)1.5, (float)1.5, (float)1.5);
	}
